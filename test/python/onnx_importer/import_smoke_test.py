...
TEST_CAST_XFAILS = [
    ...
    # Opset 23/24 new element types (float4e2m1=23, float8e8m0=24) and
    # opset 25 new element types (int2=25, uint2) not yet mapped in
    # ELEM_TYPE_TO_IR_TYPE_CB; marked xfail for now.
    "node_test_cast_FLOAT16_to_FLOAT4E2M1_model",
    "node_test_cast_FLOAT16_to_INT2_model",
    "node_test_cast_FLOAT16_to_UINT2_model",
    ...
    "node_test_cast_FLOAT_to_INT2_model",
    "node_test_cast_FLOAT_to_UINT2_model",
    "node_test_cast_INT2_to_FLOAT16_model",
    "node_test_cast_INT2_to_FLOAT_model",
    "node_test_cast_INT2_to_INT8_model",
    "node_test_cast_UINT2_to_FLOAT16_model",
    "node_test_cast_UINT2_to_FLOAT_model",
    "node_test_cast_UINT2_to_UINT8_model",
    ...
    "node_test_castlike_FLOAT16_to_INT2_expanded_model",
    "node_test_castlike_FLOAT16_to_INT2_model",
    "node_test_castlike_FLOAT16_to_UINT2_expanded_model",
    "node_test_castlike_FLOAT16_to_UINT2_model",
    ...
    "node_test_castlike_FLOAT_to_INT2_expanded_model",
    "node_test_castlike_FLOAT_to_INT2_model",
    "node_test_castlike_FLOAT_to_UINT2_expanded_model",
    "node_test_castlike_FLOAT_to_UINT2_model",
    "node_test_castlike_INT2_to_FLOAT16_expanded_model",
    "node_test_castlike_INT2_to_FLOAT16_model",
    "node_test_castlike_INT2_to_FLOAT_expanded_model",
    "node_test_castlike_INT2_to_FLOAT_model",
    "node_test_castlike_INT2_to_INT8_expanded_model",
    "node_test_castlike_INT2_to_INT8_model",
    "node_test_castlike_UINT2_to_FLOAT16_expanded_model",
    "node_test_castlike_UINT2_to_FLOAT16_model",
    "node_test_castlike_UINT2_to_FLOAT_expanded_model",
    "node_test_castlike_UINT2_to_FLOAT_model",
    "node_test_castlike_UINT2_to_UINT8_expanded_model",
    "node_test_castlike_UINT2_to_UINT8_model",
    "node_test_dequantizelinear_float4e2m1_model",
    "node_test_dequantizelinear_int2_model",
    "node_test_dequantizelinear_uint2_model",
    "node_test_quantizelinear_float4e2m1_model",
    "node_test_quantizelinear_int2_model",
    "node_test_quantizelinear_uint2_model",
]
