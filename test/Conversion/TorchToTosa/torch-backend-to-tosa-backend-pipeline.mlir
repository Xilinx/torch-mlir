...
// CHECK:           %[[VAL_2:.*]] = tosa.mul %[[VAL_0]], {{.*}}, {{.*}}: (tensor<5xbf16>, tensor<1xbf16>, tensor<1xi8>) -> tensor<5xbf16>
...
// CHECK:           %[[VAL_4:.*]] = tosa.mul %[[VAL_0]], {{.*}}, {{.*}}: (tensor<?x?xf32>, tensor<?x?xf32>, tensor<1xi8>) -> tensor<?x?xf32>
...
// CHECK: %[[VAL_5:.*]] = tosa.mul %[[VAL_3]], {{.*}}, {{.*}}: (tensor<?x?xf32>, tensor<1x1xf32>, tensor<1xi8>) -> tensor<?x?xf32>
