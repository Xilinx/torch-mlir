...
// CHECK-LABEL: torch.aten.bmm_3d_fp16
...
// -----
// CHECK-LABEL: torch.aten.bmm_3d_bf16
//      CHECK: %[[VAL_2:.+]] = tosa.matmul %0, %1 : (tensor<100x4x8xbf16>, tensor<100x8x16xbf16>) -> tensor<100x4x16xbf16>
