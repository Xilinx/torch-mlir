...
"    return %0 : !torch.list<int>\n"
"  }\n"
"  func.func @__torch__.pad_shape_fn(%arg0: !torch.list<int>, %arg1: !torch.list<int>, %arg2: !torch.bool) -> !torch.list<int> {\n"
"    %str = torch.constant.str \"AssertionError: \"\n"
"    %false = torch.constant.bool false\n"
"    %true = torch.constant.bool true\n"
...
"        %21 = torch.aten.__getitem__.t %arg1, %20 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %22 = torch.aten.add.int %arg3, %int1 : !torch.int, !torch.int -> !torch.int\n"
"        %23 = torch.aten.neg.int %22 : !torch.int -> !torch.int\n"
"        %24 = torch.aten.__getitem__.t %arg0, %23 : !torch.list<int>, !torch.int -> !torch.int\n"
...
"          %29 = torch.aten.__getitem__.t %arg1, %28 : !torch.list<int>, !torch.int -> !torch.int\n"
"          %30 = torch.aten.add.int %arg3, %int1 : !torch.int, !torch.int -> !torch.int\n"
"          %31 = torch.aten.neg.int %30 : !torch.int -> !torch.int\n"
"          %32 = torch.aten.__getitem__.t %arg0, %31 : !torch.list<int>, !torch.int -> !torch.int\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %2 = call @__torch__.pad_shape_fn(%arg0, %arg1, %true) : (!torch.list<int>, !torch.list<int>, !torch.bool) -> !torch.list<int>\n"
"    return %2 : !torch.list<int>\n"
"  }\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %4 = call @__torch__.pad_shape_fn(%arg0, %arg1, %true) : (!torch.list<int>, !torch.list<int>, !torch.bool) -> !torch.list<int>\n"
"    return %4 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.reflection_pad3d\"(%arg0: !torch.list<int>, %arg1: !torch.list<int>) -> !torch.list<int> {\n"
"    %true = torch.constant.bool true\n"
