...
"    %1 = torch.prim.TupleConstruct %0, %int11 : !torch.int, !torch.int -> !torch.tuple<int, int>\n"
"    return %1 : !torch.tuple<int, int>\n"
"  }\n"
...
"    %2 = torch.aten.eq.int %1, %int13 : !torch.int, !torch.int -> !torch.bool\n"
"    %3:2 = torch.prim.If %2 -> (!torch.bool, !torch.int) {\n"
"      torch.prim.If.yield %true, %int0 : !torch.bool, !torch.int\n"
"    } else {\n"
"      %5 = torch.prim.TupleIndex %arg0, %int1 : !torch.tuple<int, int>, !torch.int -> !torch.int\n"
"      %6 = torch.aten.eq.int %5, %int12 : !torch.int, !torch.int -> !torch.bool\n"
"      %7:2 = torch.prim.If %6 -> (!torch.bool, !torch.int) {\n"
"        torch.prim.If.yield %true, %int1 : !torch.bool, !torch.int\n"
"      } else {\n"
"        %8 = torch.prim.TupleIndex %arg0, %int1 : !torch.tuple<int, int>, !torch.int -> !torch.int\n"
"        %9 = torch.aten.eq.int %8, %int14 : !torch.int, !torch.int -> !torch.bool\n"
"        %10:2 = torch.prim.If %9 -> (!torch.bool, !torch.int) {\n"
"          torch.prim.If.yield %true, %int3 : !torch.bool, !torch.int\n"
"        } else {\n"
"          torch.prim.If.yield %false, %0 : !torch.bool, !torch.int\n"
"        }\n"
